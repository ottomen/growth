...
In object-oriented programming, SOLID is an acronym for 5 principles intended to make source code more understandable, flexible, and maintainable. Software engineer and instructor Robert C. Martin introduced the basic principles of SOLID design in his 2000 paper "Design Principles and Design Patterns".
