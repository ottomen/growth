...
So, right in the moment whe you produce low-quality code, you created a tech debt, reading debt that hits you or your collegues somewhere in the future.
...
1. Know what Code Smell means [https://refactoring.guru/refactoring/smells](https://refactoring.guru/refactoring/smells) according to your language.
2. Know Best Practices in your Framework or Library.
3. Read TS documentation regularely [https://www.typescriptlang.org/docs/handbook/intro.html](https://www.typescriptlang.org/docs/handbook/intro.html).
4. Install `ESlint` or `Biome` to your IDE.
...
7. Know what Cyclomatic Complexity means [https://en.wikipedia.org/wiki/Cyclomatic_complexity](https://en.wikipedia.org/wiki/Cyclomatic_complexity)
